...
import { Search, FileText, Home, FolderGit2, PenLine, Github, Linkedin, ExternalLink, Twitter, Mail, CodeXml, Lightbulb, Sun, Moon, Code } from "lucide-react";
  ...
  useEffect(() => {
    ...
    const handleKeyDown = (e) => {
      ...
      if (key === "h") {
        ...
        e.preventDefault();
        runCommand(() => window.open("https://www.linkedin.com/in/hongsuh-ahn-b7520a188/", "_blank"));
      } else if (key === "g") {
        e.preventDefault();
        ...
        e.preventDefault();
        runCommand(() => window.open("https://github.com/harryahnhs/v3", "_blank"));
      } else if (key === "t") {
        e.preventDefault();
          ...
          >
            ...
            <Command.List className="max-h-[300px] overflow-y-auto px-3 py-4">
              ...
              <Command.Group heading="Links" className="px-2 text-stone-500 dark:text-stone-400">
                <Command.Item
                  value="linkedin"
                  onSelect={() => runCommand(() => window.open("https://www.linkedin.com/in/hongsuh-ahn-b7520a188/", "_blank"))}
                  className="flex items-center gap-2 px-3 py-2 text-sm text-stone-600 dark:text-stone-400 rounded hover:bg-stone-100 dark:hover:bg-stone-800 cursor-pointer data-[selected=true]:bg-stone-100 dark:data-[selected=true]:bg-stone-800"
                >
                ...
                <Command.Item
                  value="github"
                  onSelect={() => runCommand(() => window.open("https://github.com/harryahnhs", "_blank"))}
                  className="flex items-center gap-2 px-3 py-2 text-sm text-stone-600 dark:text-stone-400 rounded hover:bg-stone-100 dark:hover:bg-stone-800 cursor-pointer data-[selected=true]:bg-stone-100 dark:data-[selected=true]:bg-stone-800"
                >
                ...
                <Command.Item
                  value="email"
                  onSelect={() => runCommand(() => window.open("mailto:harryahn@usc.edu", "_blank"))}
                  className="flex items-center gap-2 px-3 py-2 text-sm text-stone-600 dark:text-stone-400 rounded hover:bg-stone-100 dark:hover:bg-stone-800 cursor-pointer data-[selected=true]:bg-stone-100 dark:data-[selected=true]:bg-stone-800"
                >
                ...
                <Command.Item
                  value="source"
                  onSelect={() => runCommand(() => window.open("https://github.com/harryahnhs/v3", "_blank"))}
                  className="flex items-center gap-2 px-3 py-2 text-sm text-stone-600 dark:text-stone-400 rounded hover:bg-stone-100 dark:hover:bg-stone-800 cursor-pointer data-[selected=true]:bg-stone-100 dark:data-[selected=true]:bg-stone-800"
                >
